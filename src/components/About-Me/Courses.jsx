  ...
  return (
    <section id="courses" className="w-full flex flex-row gap-10">
      <div className="w-1/6 vertical-text pt-10 flex">
        ...
        <h1 className="lb text-8xl my-auto text-right">Notable Courses</h1>
        <div className="relative -right-10 w-0.5 flex-grow bg-lb mt-10" />
      </div>
      <div className="flex flex-col gap-20 px-20">
        <div>
          <h1 className="lb mb-0">NWEN 304</h1>
          <p className="lb mb-3 italic">Advanced Network Applications</p>
          <div className="pl-12">
            <p className="italic">Victoria University of Wellington</p>
        ...
        <div className="pl-72">
          <h1 className="lb">COMP 307</h1>
          <p className="lb mb-3 italic">
        ...
        <div>
          <h1 className="lb">COMP 309</h1>
          <p className="lb mb-3 italic">Machine Learning Tools/Techniques</p>
          <div className="pl-12">
            <p className="italic">Victoria University of Wellington</p>
            <p className="w-1/2 mt-2">
        ...
        <div className="pl-72">
          <h1 className="lb">CGRA 352</h1>
          <p className="lb mb-3 italic">Image-based Graphics</p>
          <div className="pl-12">
            <p className="italic">Victoria University of Wellington</p>
            <p className="w-1/2 mt-2">
        ...
        <div>
          <h1 className="lb">Responsive Web Design</h1>
          ...
          <div className="pl-12">
            <p className="italic">Certificate</p>
            <p className="w-1/2 mt-2">
